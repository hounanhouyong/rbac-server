package com.hn.rbac.server.common.aspect;
...
import com.hn.rbac.server.common.model.LimitType;
...
public class LimitAspect {
    ...
    @Pointcut("@annotation(com.hn.rbac.server.common.annotation.Limit)")
