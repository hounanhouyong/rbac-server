package com.hn.rbac.server.cache.service;
...
public interface RedisService {
    ...
    Long hset(String keyName, String filedName, String value) throws RedisConnectException;

    String hget(String keyName, String filedName) throws RedisConnectException;

    Long hdel(String keyName, String filedName) throws RedisConnectException;
}
