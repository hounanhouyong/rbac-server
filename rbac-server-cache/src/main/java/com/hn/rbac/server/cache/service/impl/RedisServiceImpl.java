package com.hn.rbac.server.cache.service.impl;

import com.hn.rbac.server.cache.exception.RedisConnectException;
import com.hn.rbac.server.cache.function.JedisExecutor;
import com.hn.rbac.server.cache.model.RedisInfo;
...
public class RedisServiceImpl implements RedisService {
    ...
    @Override
    public Long hset(String keyName, String filedName, String value) throws RedisConnectException {
        return this.executeByJedis(j -> j.hset(keyName, filedName, value));
    }

    @Override
    public String hget(String keyName, String filedName) throws RedisConnectException {
        return this.executeByJedis(j -> j.hget(keyName, filedName));
    }

    @Override
    public Long hdel(String keyName, String filedName) throws RedisConnectException {
        return this.executeByJedis(j -> j.hdel(keyName, filedName));
    }
